...
def Start(l):
    ...
    for tach in getTokenPage:
        ...
        if "error" in buff:
            print(f'\033[1m\033[38;5;237m[\033[38;5;54mPTC DEV\033[38;5;237m]\033[0m \033[4m\033[38;5;164m{uid_page}\033[0m \033[1;31mTHẤT BẠI RỒI LÀ ACC DIE HAY GÌ Á RA COI ĐI')
        else:
            print(f'{tim}[PTC DEV] {vangnhat}{buff} {xanhngoc} THÀNH CÔNG ✅')
