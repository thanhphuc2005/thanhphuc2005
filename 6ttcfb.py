...
from pystyle import Write, Colors, Colorate # Thêm Colorate vào đây
...
# Mã ANSI cho định dạng màu sắc terminal
...
def bes4(url):
    ...
    # Dòng này không bao giờ được thực thi vì có return trước đó
...
def _delay(value):
    while not(value <= 1):
        value -= 0.123
        print(f'''\033[1;39m[\033[1;36mPTC-DEV\033[1;32m][ \033[1;36mDELAY \033[1;35m][\033[1;36m{str(value)[0:5]}\033[1;36m][\033[1;33m|\033[1;39m ]''', '               ', end = '\r')
        sleep(0.010)
        print(f'''\033[1;39m[\033[1;36mPTC-DEV\033[1;32m][ \033[1;36mDELAY \033[1;35m][\033[1;36m{str(value)[0:5]}\033[1;36m[\033[1;33m-\033[1;39m]''', '               ', end = '\r')
        sleep(0.010)
        print(f'''\033[1;39m[\033[1;36mPTC-DEV\033[1;32m][ \033[1;36mDELAY \033[1;35m][\033[1;36m{str(value)[0:5]}\033[1;36m[\033[1;33m/\033[1;39m]''', '               ', end = '\r')
...
def countdown(value):
    while not(value <= 1) :
        value -= 0.123
        print(f'''\033[1;39m[\033[1;36mPTC-DEV\033[1;32m][ \033[1;36mDELAY \033[1;35m][\033[1;36m{str(value)[0:5]}\033[1;39m[\033[1;33mX    \033[1;39m]''', '               ', end = '\r')
        sleep(0.01)
        print(f'''\033[1;39m[\033[1;36mPTC-DEV\033[1;32m][ \033[1;36mDELAY \033[1;35m][\033[1;36m{str(value)[0:5]}\033[1;39m[\033[1;33m X   \033[1;39m]''', '               ', end = '\r')
        sleep(0.01)
        print(f'''\033[1;39m[\033[1;36mPTC-DEV\033[1;32m][ \033[1;36mDELAY \033[1;35m][\033[1;36m{str(value)[0:5]}\033[1;39m[\033[1;33m  X  \033[1;39m]''', '               ', end = '\r')
        sleep(0.01)
        print(f'''\033[1;39m[\033[1;36mPTC-DEV\033[1;32m][ \033[1;36mDELAY \033[1;35m][\033[1;36m{str(value)[0:5]}\033[1;39m[\033[1;33m   X \033[1;39m]''', '               ', end = '\r')
...
def chongblock(delaybl):
    for i in range(int(delaybl), -1, -1): # Đảm bảo delaybl là số nguyên
...
def _Share(cookie, idfb, fb1, uid):
    try:
        # Lỗi: biến `id` không được định nghĩa ở đây, nên dùng `uid`
        if not uid:
        ...
        '__dyn': '7AzHK4HwkEng5K8G6EjBAg5S3G2O5U4e2C17xt3odE98K360CEboG0x8bo6u3y4o2Gwn82nwb-q7oc81xoswMwto886C11wBz83WwgEcEhwGxu782lwv89k2C1Fwc61awkovwRwlE-U2exi4UaEW2G1jwUBwJK2W5olwUwgojUlDw-wSU8o4Wm7-2K0-poarCwLyES0Io88cA0z8c84q58jyUaUcojxK2B08-269wkopg6C13whEeE4WVU-4EdrxG1fy8bUaU',
...
def Main():
    ...
    # Đã xóa khối nhập thông tin nhiệm vụ bị lặp lại ở đây
        ...
        for ck in listck:
            ...
            while True:
                ...
                if nvlikevip == 1:
                    ...
                    like1 = listlike.text
                    like2 = listlike.json()
                    if listlike.text == '[]' or 'error' in like2: # Kiểm tra cả list rỗng và lỗi
                        print(f'\033[1;39mHết Nhiệm Vụ Like Vip:(( hoặc lỗi lấy nhiệm vụ                      ', end = '\r');sleep(2); print('                                                        ', end = '\r')
                        nvlikevip = 0
                        countdown(10) # Vẫn delay nếu hết hoặc lỗi nhiệm vụ
                    else:
                        ...
                        for x in like2:
                            try:
                                ...
                                print(f'\033[1;36mLỗi lấy thông tin nhiệm vụ, bỏ qua.               ', end = '\r'); sleep(2); print('                                                       ', end = '\r')
                                continue # Bỏ qua nhiệm vụ này và tiếp tục vòng lặp
                            ...
                            if like == False:
                                ...
                                if 'mess' in nhan:
                                    ...
                                    loilike = 0 # Reset lỗi nếu thành công

                                    if dem % int(doinick) == 0: # Ép kiểu doinick sang int
                                        ptool = 1
                                        break
                                    if dem % nvblock == 0:
                                        chongblock(int(delaybl)) # Ép kiểu delaybl sang int
                                    else:
                                        _delay(randint(int(min), int(max))) # Ép kiểu min, max sang int
                            if loilike >= int(nhiemvuloi): # Ép kiểu nhiemvuloi sang int
                                _info_after_fail = _Infofb(ck) # Kiểm tra lại cookie sau khi lỗi
                                if _info_after_fail != False:
                ...
                if nvlikethuong == 1:
                    ...
                    like2 = listlike.json()
                    if listlike.text == '[]' or 'error' in like2: # Kiểm tra cả list rỗng và lỗi
                        print(f'\033[1;32mHết Nhiệm Vụ Like Thường hoặc lỗi lấy nhiệm vụ                            ', end = '\r');sleep(2); print('                                                        ', end = '\r')
                        nvlikethuong = 0
                        countdown(10)
                    else:
                        ...
                        for x in like2:
                            ...
                            if like == False:
                                ...
                                if 'mess' in nhan:
                                    ...
                                    get = requests.get('https://tuongtaccheo.com/home.php',headers=headers).text
                                    xu = get.split('"soduchinh">')[1].split('<')[0]
                                    xu = "{:,}".format(int(xu)) # Định dạng lại xu
                                    dem+=1
                                    time = datetime.now().strftime("%H:%M:%S")
                                    # Sửa f-string và biến thời gian ở đây
                                    print(f"\033[1;31m|{dem:04d}\033[1;31m|\033[1;36mPhuocDEV\033[1;31m|\033[1;32mLIKETHUONG\033[1;31m|\033[1;35m+600xu\033[1;31m|\033[1;35m{uid_hidden}\033[1;31m|\033[1;33m{xu}\033[1;31m|\033[1;34m{user}\033[1;31m|\033[1;36m{time}")
                                    loilike = 0 # Reset lỗi nếu thành công

                                    if dem % int(doinick) == 0:
                                        ptool = 1
                                        break
                                    if dem % nvblock == 0:
                                        chongblock(int(delaybl))
                                    else:
                                        _delay(randint(int(min), int(max)))
                            if loilike >= int(nhiemvuloi):
                                _info_after_fail = _Infofb(ck)
                                if _info_after_fail != False:
                ...
                if nvreacvip == 1:
                    ...
                    like1 = listcx.text
                    like2 = listcx.json()
                    if listcx.text == '[]' or 'error' in like2:
                        print(f'\033[1;35mHết Nhiệm Vụ Cảm Xúc Vip hoặc lỗi lấy nhiệm vụ                            ', end = '\r');sleep(2); print('                                                        ', end = '\r')
                        nvreacvip = 0
                        countdown(10)
                    else:
                ...
                if nvreac == 1:
                    ...
                    like2 = listcx.json()
                    if listcx.text == '[]' or 'error' in like2:
                        print(f'\033[1;32mHết Nhiệm Vụ Cảm Xúc hoặc lỗi lấy nhiệm vụ                           ', end = '\r');sleep(2); print('                                                        ', end = '\r')
                        nvreac = 0
                        countdown(10)
                    else:
                ...
                if nvreaccmt == 1:
                    ...
                    if listcxcmt.text == '[]' or 'error' in like2:
                        print(f'\033[1;32mHết Nhiệm Vụ Cảm Xúc Cmt hoặc lỗi lấy nhiệm vụ             ', end = '\r');sleep(2); print('                                                        ', end = '\r')
                        nvreaccmt = 0
                        countdown(10)
                    else:
                ...
                if nvfollow == 1:
                    ...
                    like1 = listfl.text
                    like2 = listfl.json()
                    if listfl.text == '[]' or 'error' in like2:
                        print(f'Hết Nhiệm Vụ Follow hoặc lỗi lấy nhiệm vụ              ', end = '\r');sleep(2); print('                                                        ', end = '\r')
                        nvfollow = 0
                        countdown(10)
                    else:
                ...
                if nvcmt == 1:
                    ...
                    like1 = cmtcheo.text
                    like2 = cmtcheo.json()
                    if cmtcheo.text == '[]' or 'error' in like2:
                        print(f'Hết Nhiệm Vụ Cmt hoặc lỗi lấy nhiệm vụ              ', end = '\r');sleep(2); print('                                                        ', end = '\r')
                        nvcmt = 0
                        countdown(10)
                    else:
                ...
                if nvshare == 1:
                    ...
                    if listshare.text == '[]' or 'error' in like2:
                        print(f'Hết Nhiệm Vụ Share hoặc lỗi lấy nhiệm vụ              ', end = '\r');sleep(2); print('                                                        ', end = '\r')
                        nvshare = 0
                        countdown(10)
                    else:
                ...
                if nvlikepage == 1:
                    ...
                    if listlikepage.text == '[]' or 'error' in like2:
                        print(f'Hết Nhiệm Vụ Like Page hoặc lỗi lấy nhiệm vụ             ', end = '\r');sleep(2); print('                                                        ', end = '\r')
                        nvlikepage = 0
                        countdown(10)
                    else:
                ...
                if ptool == 1:
                    break
                # Thêm điều kiện để đảm bảo ít nhất một nhiệm vụ đang được chọn
                if not (nvlikevip or nvlikethuong or nvreacvip or nvreac or nvreaccmt or nvcmt or nvshare or nvlikepage or nvfollow):
                    for i in range(10, 0, -1):
                        Write.Print(f'Cạn Job Mẹ Rồi Hoặc Tất Cả Nhiệm Vụ Đã Hoàn Thành/Không Có Job,Vui Lòng Chờ {i} Giây...',Colors.white,interval=0.0001, end = '\r');sleep(1); print('                                                        ', end = '\r')
                    # Sau khi đợi, bạn có thể cân nhắc thoát hoặc lặp lại vòng chọn nhiệm vụ nếu muốn
                    break # Thoát khỏi vòng lặp nhiệm vụ của cookie hiện tại nếu không còn nhiệm vụ nào được chọn
                    # Hoặc có thể thêm logic để chọn lại loại nhiệm vụ nếu cần
