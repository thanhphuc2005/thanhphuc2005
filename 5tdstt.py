...
def delay(dl):
  try:
    for i in range(dl, -1, -1):
       print(f'{vang}[{trang}PTC DEV{vang}][{trang}'+str(i)+vang+']           ',end='\r')
       sleep(1)
  except:
     sleep(dl)
     print(dl,end='\r')
								...
								if cache != True:
									...
									if dem % nv_nhan == 0:
										...
										if nhan == 0:
											...
											print(f'{n-code}{luc}Nhập {red}[{vang}1{red}] {luc}Để Thay Nhiệm Vụ ')
											print(f'{n-code}{luc}Nhập {red}[{vang}2{red}] {luc}Thay Acc Tiktok ')
											print(f'{n-code}{luc}Nhấn {red}[{vang}Enter{red}] {luc}Để Tiếp Tục')
