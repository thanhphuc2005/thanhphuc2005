...
░░         ░      ░            ░ ░  ░    ░       ░░  
                  ...
                  ░            ░                 ░   
\033[97m════════════════════════════════════════════════  
\033[1;97m[\033[1;91m+\033[1;97m]\033[1;97m Zalo\033[1;31m  : \033[1;97m☞ \033[1;36m 0915 178 775 \033[1;31m♔ \033[1;97m☜
\033[1;97m[\033[1;91m+\033[1;97m]\033[1;97m Tik Tok\033[1;31m  : \033[1;33m tiktok.com/@thanhphuc2222
\033[97m════════════════════════════════════════════════
"""
        print(banner)
    def ndp_delay_tool(self, p):
        ...
        while(p>1):
            p=p-1
            print(f'[ 🌸\033[1;20mPTC DEV🌸][|][\033[1;20mLO......][{p}]','     ',end='\r');sleep(1/6)
            print(f'[ 🌸\033[1;20mPTC DEV🌸][/][\033[1;20mLOA.....][{p}]','     ',end='\r');sleep(1/6)
            print(f'[ 🌸\033[1;20mPTC DEV🌸][-][\033[1;20mLOAD....][{p}]','     ',end='\r');sleep(1/6)
            print(f'[ 🌸\033[1;20mPTC DEV🌸][+][\033[1;20mLOADI...][{p}]','     ',end='\r');sleep(1/6)
            print(f'[ 🌸\033[1;20mPTC DEV🌸][\][\033[1;20mLOADIN..][{p}]','     ',end='\r');sleep(1/6)
            print(f'[ 🌸\033[1;20MPTC DEV🌸][|][\033[1;20mLOADING.][{p}]','     ',end='\r');sleep(1/6)
